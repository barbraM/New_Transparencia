		...
		<section id="content">
			...
			<div class="content-wrap">
				...
				<div class="container clearfix nopadding">
						...
						<div class="fslider" data-pagi="false" data-animation="fade">
							<div class="flexslider">
								<div class="slider-wrap">
									<div class="slide"><a href="#"><img src="images/noticias/portadas/n-5.jpg" alt="Acuerdos con Unison"></a></div>									
								</div>
							</div>
						</div>

						<div class="entry-title uppercase">
							<h1 class="nobottommargin hidden-xs">Comunicado <span>12 de Septiembre de 2018</span></h1>					
					...
					<div class="col_full">				    
						...
						<div class="entry-content">
							<iframe src="ViewerJS/#../docs/prensa/comunicado-12-sep-18.pdf" style="width: 100%; height: 700px; border: none;"></iframe>
				...
				<div class="container clearfix">
					...
					<a href="sala-prensa.php" onclick="goBack()" class="topmargin button fright button-rounded button-reveal button-large button-teal"><i class="icon-line-arrow-left"></i><span>Regresar</span></a>
