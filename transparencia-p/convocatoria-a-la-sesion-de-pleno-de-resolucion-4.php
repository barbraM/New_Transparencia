				...
				<div class="container clearfix nopadding">
				    ...
				    <div class="col_full">					
						...
						<div class="entry-title uppercase">
							<h1 class="nobottommargin hidden-xs">Convocatoria al público en general a la Sesión de Pleno de Resolución <span>29 de Agosto</span></h1>					
							<ul class="entry-meta clearfix">
								<li><i class="icon-calendar3"></i>24 de Agosto de 2018</li>
					...
					<div class="col_full">				    
						...
						<div class="entry-content">
							<iframe src="ViewerJS/#../docs/convocatorias/convocatoria-pleno-29-agosto.pdf" style="width: 100%; height: 700px; border: none;"></iframe>
