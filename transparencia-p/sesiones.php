						...
						<div class="tab-container">
							...
							<div class="tab-content clearfix" id="tabs-25">
								<div id="posts" class="post-grid grid-container post-masonry post-timeline grid-2 clearfix">
									...
									<div class="entry entry-date-section notopmargin"><span>12 Septiembre 2018</span></div>
							...
							<!--RESOLUCIONES-->
								...
								<!--7 de Agosto-->
								<div class="toggle">
									<div class="togglet"><i class="toggle-closed icon-ok-circle"></i><i class="toggle-open icon-remove-circle"></i>Resoluciones 7 de Agosto</div>
									<div class="togglec">
								...
								<!--15 de Agosto-->
								<div class="toggle">
									<div class="togglet"><i class="toggle-closed icon-ok-circle"></i><i class="toggle-open icon-remove-circle"></i>Resoluciones 15 de Agosto</div>
									<div class="togglec">
								...
								<!--22 de Agosto-->
								<div class="toggle">
									<div class="togglet"><i class="toggle-closed icon-ok-circle"></i><i class="toggle-open icon-remove-circle"></i>Resoluciones 22 de Agosto</div>
									<div class="togglec">
								...
								<!--29 de Agosto-->
								<div class="toggle">
									<div class="togglet"><i class="toggle-closed icon-ok-circle"></i><i class="toggle-open icon-remove-circle"></i>Resoluciones 29 de Agosto</div>
									<div class="togglec">
